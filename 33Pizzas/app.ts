// Think of at least three kinds of your favorite pizza. Store these pizza names in a array, and then use a for loop to
...
let pizzas: string[] = ["Sicilian Pizza", "Margherita Pizza", "Hawaiian Pizza"];
