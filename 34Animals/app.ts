...
// list, and then use a for loop to print out the name of each animal. • Modify your program to print a statement about 
...
let typesofanimals:string[] = ["Wolf", "Tiger", "Bear"];
typesofanimals.forEach(typesofanimal => {
    console.log(`A ${typesofanimal} is a majestic animal.`);
});
console.log("They all are carnivores");